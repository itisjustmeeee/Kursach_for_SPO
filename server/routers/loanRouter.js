...
import { issueDocument, returnDocument, getLoans, getLoanById, approveLoan, rejectLoan, getActiveLoans, getOverdueLoans, getUsersLoans, getPendingLoans, getHistoryLoans } from '../controllers/loanController.js'
...
router.get('/:id/pending', authMiddleware, roleMiddleware(['admin']), permissionMiddleware('request_return_document'), getPendingLoans)
